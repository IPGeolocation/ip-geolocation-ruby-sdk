...
# Unit tests for IpgeolocationSdk::TimezoneLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IpgeolocationSdk::TimezoneLocation do
  let(:instance) { IpgeolocationSdk::TimezoneLocation.new }

  describe 'test an instance of TimezoneLocation' do
    it 'should create an instance of TimezoneLocation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(IpgeolocationSdk::TimezoneLocation)
    end
  end
